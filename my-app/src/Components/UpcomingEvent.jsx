        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p>
              ...
              explain how they would like to implement it and briefly inform
              about the components to be used. Participating teams can submit
              their presentations until the deadline for this round anytime
